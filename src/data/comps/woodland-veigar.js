...
export default {
  ...
  conditions: [
    "木灵/AP 开局，能早合纳什、法爆、青龙刀等启动装，不为了等完美神装掉血。",
    "按快 8 思路玩，4-2 或 4-5 上 8 找 7 木灵框架。",
    "有值得等待、攀阶、复制器、购物狂欢、装备补充或经济类强化时优先级显著提高。",
    "自然小法很多时才考虑慢 D 追三星，最好同时有星夜+这类追三星强化。",
    "同行少，并且没有多人卡小法、库奇、拉莫斯和木灵牌。",
  ],
  risks: [
    "把这套当默认赌小法，在 5/6 级硬 D 到经济崩。",
    "没有 7 木灵框架，还继续空等小法三星。",
    "装备明显偏物理，无法做小法启动装。",
